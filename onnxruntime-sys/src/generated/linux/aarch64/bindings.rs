...
const _: () = {
    ["Size of OrtMIGraphXProviderOptions"]
        [::std::mem::size_of::<OrtMIGraphXProviderOptions>() - 12usize];
    ["Alignment of OrtMIGraphXProviderOptions"]
        [::std::mem::align_of::<OrtMIGraphXProviderOptions>() - 4usize];
...
const _: () = {
    ...
    ["Offset of field: OrtOpenVINOProviderOptions::enable_vpu_fast_compile"]
        [::std::mem::offset_of!(OrtOpenVINOProviderOptions, enable_vpu_fast_compile) - 8usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of OrtApi"][::std::mem::size_of::<OrtApi>() - 2128usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of OrtCustomOp"][::std::mem::size_of::<OrtCustomOp>() - 152usize];
